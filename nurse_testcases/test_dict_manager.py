...
class TestCategory:
    ...
    def test_add_category_data(self,data):
        ...
        with allure.step("4. 数据库断言响应字段"):
            result = dbAssert.assert_row_exists(data.sql,params=(data.data["code"],),msg="数据库成功断言")
    ...
    def test_update_category_data(self,data):
        ...
        with allure.step("4. 数据库断言响应字段"):
            ReportEnhancer.add_sql_details(data.sql,data.sql_params)
            dbAssert.assert_field_value(data.sql,(data.sql_params,),data.filed,data.data[data.filed])
        with allure.step("5. 提取数据,接口关联"):
            pass
        with allure.step("6. 数据清理,防止数据污染"):
            pass
    ...
    def test_delete_category_data(self,data):
        ...
        with allure.step("4. 数据库断言响应字段"):
            ReportEnhancer.add_sql_details(data.sql, data.sql_params)
            dbAssert.assert_field_value(data.sql,(data.sql_params,), data.filed, var_util.get_var('category_id'))

        with allure.step("5. 提取数据,接口关联"):
            pass
        with allure.step("6. 数据清理,防止数据污染"):
            db.execute("delete from sys_dictionary_category where deleted_by = 1 and id = %s",(var_util.get_var('category_id'),))
    ...
    def test_add_category_item_data(self,data):
        with allure.step("1. 从data中获取测试请求数据"):
    ...
    def test_update_category_item_data(self,data):
        with allure.step("1. 从data中获取测试请求数据"):
        ...
        with allure.step("4. 数据库断言响应字段"):
            ...
            dbAssert.assert_field_value(data.sql,(data.sql_params,), data.filed, var_util.get_var('category_item_id'))
            ReportEnhancer.add_sql_details(data.sql, data.sql_params)
    ...
    def test_get_category_item_data(self,data):
        with allure.step("1. 从data中获取测试请求数据"):
            data = req_params_Collection(data)
    ...
    def test_delete_category_item_data(self,data):
        with allure.step("1. 从data中获取测试请求数据"):
            data = req_params_Collection(data)
            ReportEnhancer.add_request_details(url=data.url, method='delete',params=(data.params, data.data, data.json))
        ...
        with allure.step("5. 提取数据,接口关联"):
            pass
        with allure.step("6. 数据清理,防止数据污染"):
            db.execute("delete from sys_dictionary_item where deleted_by = 1 and id = %s",(var_util.get_var('category_item_id'),))
